...
class RegisterActivity : AppCompatActivity() {
    ...
    /*Creamos un método para inicializar nuestros elementos del diseño
    y la autenticación y la base de datos de firebase*/
    ...
    private fun createNewAccount() {
        ...
        if (!TextUtils.isEmpty(firstName) && !TextUtils.isEmpty(lastName)
            ...
            /*Antes de iniciar nuestro registro bloqueamos la pantalla o
            también podemos usar una barra de proceso por lo que progressbar está obsoleto*/
